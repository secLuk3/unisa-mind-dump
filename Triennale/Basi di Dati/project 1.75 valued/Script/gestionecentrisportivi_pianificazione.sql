...
CREATE TABLE `pianificazione` (
  ...
  CONSTRAINT `pianificazione_ibfk_1` FOREIGN KEY (`NomeCentro`) REFERENCES `centro` (`Nome`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `pianificazione_ibfk_2` FOREIGN KEY (`CodiceAttivita`) REFERENCES `attivita` (`Codice`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `pianificazione` VALUES ('Gold Gym',1111),('gold gym',2222),('Verdi\'s Fitness Center',2222),('Atletic Sport Center',5555),('Atletic Sport Center',6666),('Gold Gym',7777);
