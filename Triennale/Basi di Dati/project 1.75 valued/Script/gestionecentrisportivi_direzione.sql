...
CREATE TABLE `direzione` (
  ...
  CONSTRAINT `direzione_ibfk_1` FOREIGN KEY (`CfResponsabile`) REFERENCES `responsabile` (`Cf`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `direzione_ibfk_2` FOREIGN KEY (`NomeCentro`) REFERENCES `centro` (`Nome`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `direzione` VALUES ('MRDNDGRDO10','Atletic Sport Center'),('NZRRNLD9','Atletic Sport Center'),('MRDNDGRDO10','Gold Gym'),('RSSVLNT46','Gold Gym');
